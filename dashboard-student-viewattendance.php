...
if(!isset($_SESSION["rollno"]) )
  header("Location:../login-student.php?loginproperly");
?>
<!doctype html>
<html lang="en">
  <head>
  ...
  <main role="main" class="inner cover">
    ...
    <div class="item">
        <span class="cname">coursdfsdfdsfsdfdsfsdename</span><span class="fname">facultyname</span>
    </div>
    <div class="dates">
        dates absent
    </div>
    <div class="item">
        <span class="cname">coursename</span><span class="fname">facultsdfdsfsdfdsyname</span>
    </div>
    <div class="dates">
        dates absent
    </div>
